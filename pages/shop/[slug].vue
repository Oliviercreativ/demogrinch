          ...
          <div class="pb-24 mx-auto max-w-2xl">
            <div class="py-3 flex flex-col items-start justify-start gap-6 p-4">
              ...
              <div v-else class="w-full">
                <ProgressBar :is-loading="isLoading" :error="error" :reward="reward" :shop="boutique"
              ...
              <div v-if="scanSuccess"
                class="border border-blue-500 text-blue-800 dark:text-white p-4 rounded-lg mb-4 w-full">
                <div class="flex justify-start items-center gap-3 relative">
                  <svg xmlns="http://www.w3.org/2000/svg"
                    class="icon w-10 stroke-blue-800 icon-tabler icon-tabler-circle-check" width="44" height="44"
                    viewBox="0 0 24 24" stroke-width="1" stroke="#166534" fill="none" stroke-linecap="round"
                    stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                  ...
                  <p>Votre point de fidélité a bien été ajouté.</p>
                  <button @click="closeScanSuccessMessage" class="bg-white stroke-gray-500 px-2 py-1 absolute right-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-x" width="26"
                      height="26" viewBox="0 0 24 24" stroke-width="1" stroke="#166534" fill="none"
                      stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none" />
