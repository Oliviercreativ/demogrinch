    ...
    <div class="max-w-xl mx-auto bg-white rounded-lg p-6">
      ...
      <div class="text-center">
        <div class="flex items-center justify-center gap-4">
          <img src="https://media.madeinconflans.fr/wp-content/uploads/2024/05/6452416fef45718de89d7925_giagia-beige-2-p-500.png" class="w-1/2 h-32 object-contain mx-auto">
          <img src="https://media.madeinconflans.fr/wp-content/uploads/2023/09/1.png" class="w-1/2 h-32 object-contain mx-auto">
          <img src="https://api.grinch.fr/storage/v1/object/public/image/avatars/icon-mic-512-white.jpg" class="w-1/2 h-24 object-contain mx-auto">
        </div>
        <h1 class="text-2xl text-blue-800 font-bold text-center mb-2">Jeu Concours <br> Giagia x MABBAM</h1>
        <p class="text-gray-600 mb-2">Dimanche 11 mai 2025</p>
         <p class="text-gray-600 mb-2">Tenter de gagner 1 des 4 goûters offert par Giagia et GRINCH, bonne chance</p>
      </div>
...
const partenaire = 'jeu concours mabbam x giagia'

// Alternative pour le filtrage si la valeur exacte n'est pas connue
const partenaireAlternatives = [
  'jeu concours mabbam x giagia',
  'Jeu concours mabbam x giagia',
  'jeu concours MABBAM x GIAGIA',
  'Jeu Concours MABBAM x GIAGIA',
  'jeu-concours-mabbam-giagia'
]
...
const positionsGagnantes = [5, 10, 15, 25]
...
async function envoyerMessageFelicitation(userId) {
  try {
    ...
    const message = `Félicitations ! Vous avez gagné un goûter offert par Giagia et GRINCH dans le cadre du jeu concours Giagia x MABBAM x GRINCH. Rendez-vous chez Giagia Coffee en présentant ce message dans la messagerie pour récupérer votre récompense.`
