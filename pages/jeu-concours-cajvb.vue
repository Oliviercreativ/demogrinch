    ...
    <div class="max-w-xl mx-auto bg-white rounded-lg p-6">
      ...
      <div class="text-center">
        <div class="flex justify-center items-center gap-4 flex-row">
          ...
          <img src="https://api.grinch.fr/storage/v1/object/public/image/avatars/icon-mic-512-white.jpg" class="w-48 h-48 object-contain mx-auto mb-8">
        </div>
      ...
      <div v-if="winner" class="mt-6 p-4 rounded-lg text-center" :class="winner === 'perdu' ? 'bg-red-100' : 'bg-blue-100'">
        ...
        <div v-else class="text-blue-800 font-semibold">
          <p>Vous avez gagné {{ winner }} !</p>
          <p>Vous pouvez récupérer votre lot à la buvette en présentant votre smartphone</p>
          <p class="text-blue-700 font-bold mt-2">Allez CA-J !</p>
        </div>
      </div>
      <div v-if="aDejaJoue && participationsRestantes === 0" class="my-6 p-4 rounded-lg text-center">
